...
function SearchResult({ country, city, originCity, dates, carrier, cost, direct,cityData }) {
    const [save, setSave] = useState(false);
    const [imgSrc, setImgSrc] = useState("https://www.esky.eu/_fe/img/city_" + cityData.IataCode + "_horizontal_0.jpg");

    let id = cityData.IataCode;
    ...
    function handleSave() {
        if (save === false) {
            ...
            myNewObject.set('cityId', cityData.IataCode);
