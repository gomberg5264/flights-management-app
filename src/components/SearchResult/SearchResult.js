...
function SearchResult({activeUser, country, city, dates, carrier, cost, direct, cityData, Save, onSave, index }) {
            ...
            <Col sm={12} md={9}>
                <div className="search-data">
                    <div>
                        <h4>{city}, {country}</h4>
                        {
                            activeUser && <div id={save ? "1" : "0"} onClick={onSaveClicked} data-myattr={index}>
